...
from myapi.views import StudentClassBaseView, StudentsFunBaseView, StudentClassViewSet
...
router.register(r'allstudents', StudentClassViewSet, basename='allstudents')
...
urlpatterns = [
    ...
    path("StudentsView/", StudentsFunBaseView, name="StudentsView"), 
    path('students/', StudentClassBaseView.as_view(), name='students'),
...
path('blog/', include('blog.urls'))-->router.urls
